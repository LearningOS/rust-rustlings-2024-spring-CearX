    ...
    T: Default,
{
    ...
    fn heapify_down(&mut self, mut idx: usize) {
        loop {
            ...
            if left_idx < self.count && !(self.comparator)(&self.items[smallest], &self.items[left_idx]) {
                smallest = left_idx;
            }
    
            if right_idx < self.count && !(self.comparator)(&self.items[smallest], &self.items[right_idx]) {
                smallest = right_idx;
            }
